...
module.exports = function ({
	...
	const previousPoint = route[closestPointIndex - 1];
	...
	if (Number.isNaN(routePoint.latitude)) {
		throw (new TypeError('routePoint is NaN'));
	}
	...
	if (typeof (routePoint) === 'undefined') {
		throw (new TypeError('undefined route point'));
	}
	...
	if (Number.isNaN(distanceMade)) {
		throw (new TypeError('distanceMade is NaN'));
	}
