...
test('Route progress 1', t => {
	...
	const res1 = getRouteProgress(Object.assign({point: pointBefore}, options));
	const res2 = getRouteProgress(Object.assign({point: pointAfter}, options));
...
test('Route progress 4', t => {
	...
	const res2 = getRouteProgress(Object.assign({point: pointAfter}, options2));
...
const macroBasicRoute = function (t, point1, point2, expected, route = defaultRoute, routeIndex = 0) {
	...
	const res1 = getRouteProgress(Object.assign({point: point1}, options));
	const res2 = getRouteProgress(Object.assign({point: point2}, options));
